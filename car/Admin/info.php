...
<div class="container">
    ...
    <div> 
        ...
        echo "
    <a href='activate_car.php?id=$car_id&dbit=0'><button class='verify_button'> Verify </button></a>
    <a href='activate_car.php?id=$car_id&dbit=1'><button class='delete_button'> Remove </button></a>";
        }
    ?>
    </div>
</div>
